...
// ===============================
// LISTA DE PENDENTES + KPI (REALTIME)
// ===============================
    ...
    snapshot.forEach(doc => {
      ...
      lista.innerHTML += `
        <tr class="pendente">
          ...
          <td data-label="Solicitado em">${solicitado.toLocaleString()}</td>
        ...
        if (abastecido >= inicio && abastecido <= fim) {
          ...
          historico.innerHTML += `
            <tr class="finalizado">
              ...
              <td data-label="Partnumber">${d.partnumber}</td>
              <td data-label="Quantidade">${d.quantidade}</td>
              <td data-label="Solicitado em">${d.solicitadoEm.toDate().toLocaleString()}</td>
              <td data-label="Abastecido em">${abastecido.toLocaleString()}</td>
...
// ===============================
// GRÁFICO PROFISSIONAL CORPORATIVO
// ===============================
let grafico;
