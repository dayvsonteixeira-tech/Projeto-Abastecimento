...
function solicitarMaterial() {
  ...
  if (!doca || !solicitante || !posicao || !partnumber) || !quantidade || !comentarios {
  ...
  ["doca","solicitante","posicao","partnumber","quantidade","comentarios"]
...
function atualizarDashboard(snapshot) {
  ...
  const el = document.getElementById("kpiPendentes");
  if (el) el.innerText = pendentes;
}


// Função para salvar comentario 
