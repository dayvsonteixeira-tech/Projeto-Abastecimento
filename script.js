...
storageBucket:"controle-abastecimento-f80ed.appspot.com"
})
...
// UPLOAD FOTO
async function uploadImagem(file,id){

const ref=storage.ref().child("fotos/"+id+"_"+Date.now())
...
if(arquivos[id]){
urlFoto=await uploadImagem(arquivos[id],id)
}
