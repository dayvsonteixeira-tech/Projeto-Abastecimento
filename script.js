...
db.collection("solicitacoes")
  ...
  .onSnapshot(snapshot => {
    ...
    // Verifica se o mês virou e limpa o controle local
    verificarResetMes()

    // Referência do mês/ano atual para filtrar o gráfico
    const agora     = new Date()
    ...
    snapshot.forEach(doc => {
      ...
      // ✅ GRÁFICO: exibe apenas registros do mês atual
...
function atualizarGrafico(dados) {
  ...
  // Título dinâmico com mês/ano atual
  const agora      = new Date()
